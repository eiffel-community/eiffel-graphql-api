...
def eiffel_artifact_created_event():
    return {
        ...
        "data": {
            ...
            "implements": [
                "pkg:composition/link/test@1.0.0"
            ],
            "dependsOn": [
                "pkg:environment/link/test@1.0.0"
            ],
...
def eiffel_artifact_created_event_composition_link():
    return {
        ...
        "links": [
            {
                "type": "COMPOSITION",
                "target": "460ff165-125d-468f-a5d2-677d5a939507"
            }
        ],
        "data": {
...
def eiffel_artifact_created_event_environment_link():
    return {
        ...
        "links": [
            {
                "type": "ENVIRONMENT",
                "target": "0639dc49-8f4f-4732-899e-3aefc66a5bfb"
            }
        ],
        "data": {
...
def eiffel_artifact_created_event_previous_version_link():
    return {
        ...
        "data": {
            "identity": "pkg:previous_version/link/test@1.0.0"
        }
    }
...
def eiffel_composition_defined():
    return {
        ...
        "links": [],
        "data": {
            "name": "Test composition for EiffelDB"
        }
    }
...
def eiffel_environment_defined():
    return {
        ...
        "links": [],
        "data": {
            "name": "Test environment for EiffelDB"
        }
    }
